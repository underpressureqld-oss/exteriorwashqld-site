...
const Footer = () => {
  return <footer className="bg-slate-950 text-slate-300 pt-16 pb-8 border-t border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/driveway-cleaning" className="hover:text-primary transition-colors">Driveway Cleaning</Link></li>
              <li><Link to="/roof-cleaning" className="hover:text-primary transition-colors">Roof Cleaning</Link></li>
              <li><Link to="/house-washing" className="hover:text-primary transition-colors">House Washing</Link></li>
              <li><Link to="/solar-panel-cleaning" className="hover:text-primary transition-colors">Solar Panel Cleaning</Link></li>
              <li><Link to="/gutter-cleaning" className="hover:text-primary transition-colors">Gutter Cleaning</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/pressure-cleaning-brisbane" className="hover:text-primary transition-colors">Brisbane</Link></li>
              <li><Link to="/pressure-cleaning-sunshine-coast" className="hover:text-primary transition-colors">Sunshine Coast</Link></li>
              <li><Link to="/pressure-cleaning-gold-coast" className="hover:text-primary transition-colors">Gold Coast</Link></li>
              <li><Link to="/pressure-cleaning-logan" className="hover:text-primary transition-colors">Logan</Link></li>
              <li><Link to="/pressure-cleaning-redcliffe" className="hover:text-primary transition-colors">Redcliffe</Link></li>
              <li><Link to="/pressure-cleaning-ipswich" className="hover:text-primary transition-colors">Ipswich</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="leading-relaxed">Brisbane & Sunshine Coast,<br />Queensland, Australia</span>
              </li>
              <li className="pt-2">
